...
public class GameAppTest {
    ...
    private Developer developerMinecraft = new Developer("Minecraft", "www.minecraft.com");
    ...
    void tearDown() {
        ...
        developerLego = developerMinecraft = null;
    }
    ...
    class Getters {
        ...
        @Test
        void getMultiplayer() {
            assertEquals(true, gameAppBelowBoundary.isMultiplayer());
            assertEquals(true, gameAppOnBoundary.isMultiplayer());
            assertEquals(false, gameAppAboveBoundary.isMultiplayer());
            assertEquals(false, gameAppInvalidData.isMultiplayer());
        }
    }
    ...
    class Setters {
        ...
        void setDeveloper() {
            ...
            assertEquals(developerLego, gameAppBelowBoundary.getDeveloper());
            gameAppBelowBoundary.setDeveloper(developerMinecraft);
            assertEquals(developerMinecraft, gameAppBelowBoundary.getDeveloper());
        }
        ...
        @Test
        void setMultiplayer() {
            //true/false for Multiplayer
            assertEquals(true, gameAppBelowBoundary.isMultiplayer());

            gameAppBelowBoundary.setMultiplayer(false);
            assertEquals(false, gameAppBelowBoundary.isMultiplayer()); //update

            gameAppBelowBoundary.setMultiplayer(true);
            assertEquals(true, gameAppBelowBoundary.isMultiplayer()); //no update
    ...
    class ObjectStateMethods {
        ...
        void appSummaryReturnsCorrectString() {
            ...
            assertTrue(stringContents.contains("Multiplayer: " + gameApp.isMultiplayer()));
    ...
    class RecommendedApp {
        ...
        void appIsNotRecommendedWhenRatingIsLessThan4() {
            //setting all conditions to true with ratings of 3 and 1 (i.e. 2)
            GameApp gameApp = setupGameAppWithRating(3, 1);
        ...
        void appIsRecommendedWhenAllOfTheConditionsAreTrue() {
            //setting all conditions to true with ratings of 4 and 5 (i.e. 4.5)
    ...
    GameApp setupGameAppWithRating(int rating1, int rating2) {
        ...
        assertEquals(true, gameApp.isMultiplayer());
